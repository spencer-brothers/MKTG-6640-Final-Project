...
svm_model <- svm(StarRating ~ ., data = train_data, kernel = "radial", cost = 1, gamma = 1/ncol(train_data))
...
lasso_model <- glmnet(X, y, alpha = 1, lambda = .004893966)

lm_preds <- predict(lasso_model, s = .004893966, newx = X_test)
